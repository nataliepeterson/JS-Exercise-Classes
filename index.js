...
drive(distance){
  const drivingMiles = this.tank * this.milesPerGallon; 
...
const Natalie= new Lambdasian({name:"natalie", age: 32, location: "phx"});
console.log(Natalie)
...
/*const MrP = new Instructor({name:"Rodger", age:90, location:"florida", specialty:"math", favLanguage:"spanish", catchPhrase: "i love wine"});
console.log(MrP);

grade(
console.log(MrP.studentAttr, "math"));
